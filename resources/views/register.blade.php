            ...
            <!-- form start -->
                <form class="form-horizontal" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="inputPassword3" class="col-sm-12 col-form-label">ConfirmPassword</label>
                            <div class="col-sm-12">
                                <input type="password" name="confirmpassword" class="form-control" id="inputPassword3" placeholder="ConfirmPassword"
                    ...
                    <div class="card-footer d-flex align-items-right">
                        <a href="{{ url('login') }}">
                            <button type="submit" class="btn btn-info ml-auto">Sign in</button>
                        </a>
                    </div>
                    <!-- /.card-footer -->
        </div>
